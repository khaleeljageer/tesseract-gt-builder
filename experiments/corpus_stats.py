...
def exemplar_tiers(counts, n_fonts=27):
...
{body}
\\midrule
\\textbf{{Full corpus}} & \\textbf{{{full['lines']:,}}} &
\\textbf{{{full['graphemes']:,}}} & \\textbf{{{s['covered']}/{s['total']}}} \\\\
\\bottomrule
\\end{{tabular}}
\\caption{{Corpus composition and syllabary coverage. The final column counts
